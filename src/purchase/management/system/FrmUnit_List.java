...
public class FrmUnit_List extends javax.swing.JDialog {
    ...
    private void Wprv_ShowDB() {
        ...
        try {
            ...
            if (chkAll.isSelected() == false) {
                sSql = " Where unitcode Like '%" + txtSearch.getText().trim() + "%' OR "
                         + "nthai Like '%" + txtSearch.getText().trim() + "%' ";
            }          
            
            jh_center_cn.Cpuv_GetRowPage();
            
            String sSqlShow = " Select * From unit "+sSql+" Limit " + jh_center_cn.piStart + ", " + jh_center_cn.piEnd + "";
            ...
            int iRowAll = jh_center_cn.Cpui_RowsAll("Select count(unitcode) As Num From unit ", "Num");
            if (iRowAll == 0) {
                iRowAll = 1;
    ...
    public FrmUnit_List(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        dgvShow.setPreferredSize(new java.awt.Dimension(428, 399));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(cmdSearch, javax.swing.GroupLayout.PREFERRED_SIZE, 58, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(cmdRefresh)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(chkAll, javax.swing.GroupLayout.DEFAULT_SIZE, 93, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmUnit_List dialog = new FrmUnit_List(new javax.swing.JFrame(), true);
