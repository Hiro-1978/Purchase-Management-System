...
public class FrmBase_Show extends javax.swing.JInternalFrame {
        ...
        try {
            ...
            if (chkAll.isSelected() == false) {
                if (cmbSelect.getSelectedIndex() == 0) {
                    sSql = "Where bname like '%" + txtSearch.getText().trim() + "%'";
                } else {
            ...
            String sSqlShow = "select * from basetype " + sSql.trim() + " Limit " + jh_center_cn.piStart + ", " + jh_center_cn.piEnd + " ";
            ...
            int iRowAll = jh_center_cn.Cpui_RowsAll("Select count(baseid) As Num From basetype " + sSql.trim() + "", "Num");
            if (iRowAll == 0) {
                iRowAll = 1;
            }
    ...
    private void initComponents() {
        ...
        cmbSelect.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "ชื่อหมวดหมู่", "รหัสหมวดหมู่" }));
        ...
        dgvShow.setPreferredSize(new java.awt.Dimension(643, 399));
    ...
    private void mnsAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnsAddActionPerformed
        FrmBase_Save Frm = new FrmBase_Save(null, closable);
        Frm.psAction = "ADD";
        Frm.setModal(true);
    ...
    private void dgvShowMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dgvShowMouseClicked
        ...
        mnsEdit.setText("แก้ไขหมวดหมู่ รหัส: " + sCode);
        mnsDelete.setText("ยกเลิกหมวดหมู่ รหัส: " + sCode);
